...
`pct_late_arrival_00_01` | Float. Percent of arrivals between on-time and 1 minute late.
`pct_late_arrival_01_05` | Float. Percent of arrivals between 1 minute and 5 mintues late.
`pct_late_arrival_05_10` | Float. Percent of arrivals between 5 minutes and 10 minutes late.
`pct_late_arrival_10_15` | Float. Percent of arrivals between 10 minutes and 15 minutes late.
`pct_late_arrival_15+` 	| Float. Percent of arrivals more than 15 minutes late.
`pct_late_departure_00_01` | Float. Percent of departures between on-time and 1 minute late.
`pct_late_departure_01_05` | Float. Percent of departures between 1 minute and 5 mintues late.
`pct_late_departure_05_10` | Float. Percent of departures between 5 minutes and 10 minutes late.
`pct_late_departure_10_15` | Float. Percent of departures between 10 minutes and 15 minutes late.
`pct_late_departure_15+` | Float. Percent of departures more than 15 minutes late.
